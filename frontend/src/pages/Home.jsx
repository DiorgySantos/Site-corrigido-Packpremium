...
export const Home = () => {
  ...
  // Mantém tracking de parâmetros para os links da Kiwify
  useEffect(() => {
    ...
    <div className="min-h-screen bg-black text-white selection:bg-blue-600 selection:text-white">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center">
            ...
            <p className="text-base sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mt-8 sm:mt-10 leading-relaxed">
              ...
              <span className="font-bold text-white">profissional, cinematográfica e impactante</span> — mesmo se você
              ainda não é avançado.
            </p>

            {/* CTAs — agora empurrando o R$87 */}
            <div className="pt-8 sm:pt-10 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              ...
              <a
                ...
                className="inline-flex items-center justify-center bg-zinc-900 hover:bg-zinc-800 text-white font-black text-sm sm:text-lg px-6 sm:px-10 py-4 sm:py-6 rounded-full transition-all duration-300 hover:scale-105 w-full sm:w-auto border border-zinc-800"
              >
                Quero só a Plataforma (R$27)
                <ChevronRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
              </a>
            </div>

            <p className="text-gray-500 text-xs sm:text-sm mt-5">
              Recomendado para tráfego frio: <span className="text-gray-300 font-bold">Combo com Plugin (R$87)</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black via-zinc-950 to-black relative overflow-hidden">
        <div className="hidden md:block absolute inset-0 opacity-10 pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-600/30 rounded-full filter blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-700/20 rounded-full filter blur-3xl" />
        </div>

        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-16">
            <Badge className="bg-blue-600/20 text-blue-500 border-blue-600/30 mb-4">Exemplos de Cenas</Badge>
      ...
      <section className="py-20 px-4 bg-zinc-950">
        <div className="container mx-auto max-w-4xl">
          <h3 className="text-3xl md:text-4xl font-bold mb-8 text-center">
            O que é o <span className="text-blue-600">Combo com Plugin?</span>
          </h3>

          <div className="prose prose-lg prose-invert max-w-none text-center">
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              É a combinação exata entre <strong className="text-blue-600">material de elite</strong> e{' '}
              <strong className="text-blue-600">velocidade real</strong>.
            </p>

            <p className="text-gray-400 text-md leading-relaxed mb-10">
              Você não compra um pack. Você compra um <strong className="text-white">workflow cinematográfico</strong>
              : buscar, pré-visualizar e aplicar em 1 clique — direto no Premiere/After.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 text-left">
              ...
              <div className="flex items-start space-x-3 bg-zinc-900/50 p-5 rounded-xl border border-zinc-800 hover:border-blue-600/30 transition-all">
                <Check className="h-6 w-6 text-blue-600 flex-shrink-0 mt-1" />
                <span className="text-gray-200 font-medium">Pré-visualização rápida com um simples passar do mouse</span>
              </div>

              <div className="flex items-start space-x-3 bg-zinc-900/50 p-5 rounded-xl border border-zinc-800 hover:border-blue-600/30 transition-all">
                <Check className="h-6 w-6 text-blue-600 flex-shrink-0 mt-1" />
                <span className="text-gray-200 font-medium">Organização por estilo, tema e objetivo</span>
              </div>
              ...
              <div className="flex items-start space-x-3 bg-blue-600/10 p-5 rounded-xl border border-blue-600/20 hover:border-blue-600/40 transition-all shadow-[0_0_15px_rgba(37,99,235,0.12)]">
                ...
                <span className="text-blue-50 font-bold">O Plugin transforma tudo em 1 clique dentro do software</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-4 bg-zinc-950 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Veja o resultado de alguns vídeos utilizando cenas de filmes combinado com legendas dinâmicas.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <p className="text-gray-400 mb-6 text-lg">Comece a editar em minutos com um workflow de elite.</p>
      ...
      {/* O que você recebe (removeu os cards de treinamento como destaque) */}
      <section className="py-20 px-4 bg-black">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl bg-zinc-900/50 border border-zinc-800 hover:border-blue-600/30 transition-all group relative overflow-hidden">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Cenas cinematográficas prontas para usar, separadas por estilo e objetivo.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-zinc-900/50 border border-zinc-800 hover:border-blue-600/30 transition-all group relative overflow-hidden">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Referências prontas para acabar com bloqueio criativo e acelerar ideias.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-zinc-900/50 border border-zinc-800 hover:border-blue-600/30 transition-all group relative overflow-hidden">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Categorias prontas para cada tipo de vídeo, cena e objetivo.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl md:text-3xl font-bold mb-2 text-center lg:text-left">
                Com o Plugin você vai...
              </h3>

              <p className="text-gray-400 text-sm text-center lg:text-left mb-4">
                (e se quiser evoluir ainda mais, existe o Plano PRO com treinamento completo.)
              </p>
              ...
              <div className="flex items-start space-x-3 bg-green-950/40 p-4 rounded-lg border border-green-500/50 shadow-lg shadow-green-500/10">
                ...
                <span className="text-gray-100 font-medium">
                  Buscar, pré-visualizar e aplicar cenas em 1 clique — direto no software.
                </span>
              </div>
      ...
      {/* BÔNUS — agora trabalhando para o R$87 (apenas 3) */}
      <section id={OFFER_SECTION_BONUS_ANCHOR} className="py-24 px-4 bg-zinc-950 overflow-hidden relative">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-14">
            ...
            <h3 className="text-3xl md:text-5xl font-black mb-4 text-white tracking-tight leading-tight uppercase">
              Comprando o <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-700">Combo com Plugin (R$87)</span>
              <br />
              você ainda recebe:
            </h3>

            <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
              Packs rápidos para você editar mais rápido e com mais impacto — sem pagar nada a mais.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {bonuses.slice(0, 3).map((bonus, index) => (
              <div
                key={index}
                className="bg-zinc-900/40 border border-zinc-800 rounded-3xl p-6 hover:border-blue-600/40 transition-all"
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-blue-500 font-black text-xs uppercase tracking-widest">Bônus incluso</span>
                </div>

                <h4 className="text-lg font-black text-white uppercase italic leading-tight mb-3">{bonus.title}</h4>
...
')[0].replace(/^- /, '').trim()}
                ...
                <div className="mt-5 flex items-center gap-2 text-xs font-bold text-blue-200">
                  <Check className="w-4 h-4 text-blue-600" />
                  Incluso no Combo com Plugin
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto">
              Se você quer velocidade de verdade, o <span className="text-blue-500 font-bold">Combo com Plugin (R$87)</span>{' '}
              é o melhor caminho.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
            ...
            <div
              id="plano-plataforma"
              className="bg-zinc-900/40 border border-zinc-800 rounded-[2.5rem] p-8 sm:p-10 flex flex-col hover:border-zinc-700 transition-all opacity-95"
            >
              <div className="mb-8 text-left">
                <h4 className="text-xl font-bold text-gray-400 uppercase tracking-widest mb-2">Plataforma</h4>

                <div className="flex flex-col gap-1">
                  <span className="text-4xl sm:text-5xl font-black text-white italic">6x de R$ 5,07</span>
                  <span className="text-zinc-400 text-sm">ou R$ 27 à vista</span>
                </div>

                <p className="text-zinc-500 mt-3 text-sm italic">
                  Para quem quer apenas a biblioteca (sem plugin de 1 clique).
                </p>
              </div>
            ...
            >
              ...
              <div className="mb-8 text-left">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-5xl sm:text-6xl font-black text-white italic">12x de R$ 9,00</span>
                  <span className="text-blue-200/70 text-sm">ou R$ 87 à vista</span>
                </div>

                <p className="text-blue-600/80 mt-3 italic text-sm font-medium">
                  O combo ideal para editar em minutos e economizar horas.
                </p>
              </div>
              ...
              <div className="space-y-4 flex-1">
                ...
                <div className="bg-blue-600/10 p-5 rounded-2xl border border-blue-600/30 mb-2">
                  <div className="flex items-center gap-3 text-white font-black uppercase text-sm mb-1">
                    <Star className="h-5 w-5 text-blue-600 fill-blue-600" /> Bônus por tempo limitado
                  </div>
                  <p className="text-blue-200/70 text-xs italic pl-8 leading-relaxed">
                    Packs extras para você editar mais rápido (LUTs, SFX, overlays...).
                  </p>
                </div>

                <div className="flex items-center gap-3 text-gray-300 text-sm">
                  <Check className="h-5 w-5 text-blue-600" /> Acesso vitalício
                </div>

                <div className="flex items-center gap-3 text-gray-300 text-sm">
                  <Check className="h-5 w-5 text-blue-600" /> Atualizações mensais
                </div>
              ...
              >
                Quero o Combo com Plugin agora{' '}
            ...
            <div
              ...
              className="relative bg-zinc-900/40 border border-zinc-800 rounded-[2.5rem] p-8 sm:p-10 flex flex-col hover:border-zinc-700 transition-all opacity-95"
            >
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-zinc-800 text-white text-xs font-black px-6 py-1.5 rounded-full uppercase tracking-widest shadow-xl border border-zinc-700">
                PLANO PRO
              </div>

              <div className="mb-8 text-left">
                <h4 className="text-xl font-bold text-gray-200 uppercase tracking-widest mb-2 italic">Editor Premium</h4>

                <div className="flex flex-col gap-1">
                  <span className="text-4xl sm:text-5xl font-black text-white italic">12x de R$ 15,41</span>
                  <span className="text-zinc-400 text-sm">ou R$ 149 à vista</span>
                </div>

                <p className="text-zinc-400 mt-3 italic text-sm font-medium">
                  Para quem quer o pacote completo + treinamento e suporte VIP.
                </p>
              </div>

              <div className="space-y-4 flex-1">
                <div className="flex items-center gap-3 text-white font-bold text-sm">
                  <Zap className="h-5 w-5 text-blue-600" /> Inclui tudo do Combo com Plugin
                </div>

                <div className="bg-zinc-950/70 p-5 rounded-2xl border border-zinc-800 mb-2">
                  <div className="flex items-center gap-3 text-white font-black uppercase text-sm mb-1">
                    <Star className="h-5 w-5 text-blue-600" /> Treinamento completo
                  </div>
                  <p className="text-zinc-400 text-xs italic pl-8 leading-relaxed">
                    Legendas dinâmicas e imersivas para elevar o nível e reter atenção.
                  </p>
                </div>

                <div className="flex items-center gap-3 text-gray-200 text-sm">
                  <Check className="h-5 w-5 text-blue-600" /> Scripts de automação no After Effects
                </div>

                <div className="flex items-center gap-3 text-gray-200 text-sm">
                  <Check className="h-5 w-5 text-blue-600" /> Packs Premium (LUTs, SFX, hooks, overlays)
                </div>

                <div className="flex items-center gap-3 text-gray-200 text-sm">
                  <Check className="h-5 w-5 text-blue-600" /> Comunidade + suporte VIP
                </div>
              ...
              <p className="text-center text-zinc-500 text-xs mt-3">Upgrade completo</p>
            </div>
          </div>

          <p className="text-center text-gray-500 text-xs mt-8 max-w-3xl mx-auto">
            O treinamento completo agora é focado no Plano PRO (R$149). Para o Combo com Plugin (R$87), a estratégia
            recomendada é oferecer o treinamento como <span className="text-gray-300 font-bold">order bump</span> no
            checkout.
          </p>
        </div>
      </section>
      ...
      <div className="py-12 bg-zinc-950 flex justify-center px-4 border-t border-zinc-900">
        ...
        >
          GARANTIR MEU COMBO COM PLUGIN <ChevronRight className="h-4 w-4 sm:h-5 sm:w-5 ml-2 animate-pulse" />
        </a>
      </div>
